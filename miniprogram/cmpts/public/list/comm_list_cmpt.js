...
Component({
	...
	methods: {
		...
		_getList: async function (page) {
			...
			opt.title = 'bar';
			await chelper.dataList(this, '_dataList', this.data.route, params, opt);
		...
		bindSearchTap: function (e) {
			wx.navigateTo({
				url: pHelper.fmtURLByPID('/pages/search/search?type=' + this.data.type + '&returnUrl=' + this.data.returnUrl)
			});
		},
